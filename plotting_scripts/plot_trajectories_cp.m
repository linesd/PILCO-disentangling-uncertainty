...
name = "/home/dl00065/Documents/MATLAB/thesis/PILCO/pilcoV0.9/cartpole_plots/data_"+num2str(dataset) +"/trajectories_" + num2str(episode) + ".mat";
...
name = "/home/dl00065/Documents/MATLAB/thesis/PILCO/pilcoV0.9/cartpole_plots/data_"+num2str(dataset) +"/X_data_" + num2str(episode) + ".mat";
X_data = load(name);
X = X_data.X_tr;

% load uncertainty data (should always be the last episode)
name = "/home/dl00065/Documents/MATLAB/thesis/PILCO/pilcoV0.9/cartpole_plots/data_"+num2str(dataset) +"/uncertainty_15.mat";
uncertainty = load(name);
unc = uncertainty.uncertainty;

% load fantasy data (should always be the last episode)
name = "/home/dl00065/Documents/MATLAB/thesis/PILCO/pilcoV0.9/cartpole_plots/data_"+num2str(dataset) +"/fantasy_data_15.mat";
fantasy = load(name);
...
for dd = 1:D-1
    ...
    name = "/home/dl00065/Documents/MATLAB/thesis/PILCO/pilcoV0.9/cartpole_plots/trajectory_plots/MC_rollout_Ep_"+num2str(episode) + "_Dim_" + num2str(dd) + ".png";
...
legend('95% confidence interval','Average cost per episode','Total uncertainty','Epistemic uncertainty',' Aleatoric uncertainty')
xlabel("Episode")
ylabel("Uncertainty")
ylim([1e-5 10])
xlim([1 15])
...
name = "/home/dl00065/Documents/MATLAB/thesis/PILCO/pilcoV0.9/cartpole_plots/trajectory_plots/uncertainty.png";
print(gcf,name,'-dpng','-r400'); 
