 ...
 %% MY STUFF FROM HERE
  ...
  parfor mm =1:M_num
      ...
      for ii = 1:N_num
          ...
          states(ii, 3:4) = [sin(states(ii,angi)) cos(states(ii, angi))];
      end
...
% save all the data
name = "../../myData/pendulum_plots/data_" + num2str(save_at) +"/X_data_" + num2str(j); 
save(name, "X_tr")
name = "../../myData/pendulum_plots/data_" + num2str(save_at) +"/Y_data_" + num2str(j); 
save(name, "Y_tr")
name = "../../myData/pendulum_plots/data_" + num2str(save_at) +"/trajectory_costs_" + num2str(j); 
save(name, "trajectory_costs")
name = "../../myData/pendulum_plots/data_" + num2str(save_at) +"/trajectories_" + num2str(j); 
save(name, "trajectories");
name = "../../myData/pendulum_plots/data_" + num2str(save_at) +"/uncertainty_" + num2str(j); 
