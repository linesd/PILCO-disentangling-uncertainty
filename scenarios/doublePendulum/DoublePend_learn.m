...
for mm =1:M_num
  ...
  for tt = 1:T_num
    ...
    for nn = 1:N_num
        ...
        states(nn,9:10) = policy.fcn(policy,states(nn,poli)',zeros(length(poli)));% append policy
    end
...
% save all the data
name = "../../myData/doublePend_plots/data_" + num2str(save_at) +"/X_data_" + num2str(j); 
save(name, "X_tr")
name = "../../myData/doublePend_plots/data_" + num2str(save_at) +"/Y_data_" + num2str(j); 
save(name, "Y_tr")
name = "../../myData/doublePend_plots/data_" + num2str(save_at) +"/trajectory_costs_" + num2str(j); 
save(name, "trajectory_costs")
name = "../../myData/doublePend_plots/data_" + num2str(save_at) +"/trajectories_" + num2str(j); 
save(name, "trajectories");
name = "../../myData/doublePend_plots/data_" + num2str(save_at) +"/uncertainty_" + num2str(j); 
save(name, "uncertainty");
name = "../../myData/doublePend_plots/data_" + num2str(save_at) +"/fantasy_data_" + num2str(j); 
save(name, "fantasy");
